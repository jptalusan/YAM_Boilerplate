...
class WorkerProcess(zp.ZmqProcess):
    ...
    """
    def __init__(self, bind_addr, broker_addr, publish_addr, identity=None):
        super().__init__()
    ...
    def setup(self):
        ...
        self.publisher_stream, _ = self.stream(zmq.PUB, self.publish_addr, bind=True, identity=self.identity)
